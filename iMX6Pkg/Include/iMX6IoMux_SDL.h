...
typedef enum {
  IMX_PAD_GPIO_0 = IMX_IOMUX_PAD_DEFINE (0x5DC, 0x20C), // CCM_CLKO1
  IMX_PAD_GPIO_1 = IMX_IOMUX_PAD_DEFINE (0x5E0, 0x210), // ESAI_RX_CLK
  IMX_PAD_GPIO_2 = IMX_IOMUX_PAD_DEFINE (0x5F4, 0x224), // ESAI_TX_FS
  IMX_PAD_GPIO_3 = IMX_IOMUX_PAD_DEFINE (0x5F8, 0x228), // ESAI_RX_HF_CLK
  IMX_PAD_GPIO_4 = IMX_IOMUX_PAD_DEFINE (0x5FC, 0x22C), // ESAI_TX_HF_CLK
  IMX_PAD_GPIO_5 = IMX_IOMUX_PAD_DEFINE (0x600, 0x230), // ESAI_TX2_RX3
  IMX_PAD_GPIO_6 = IMX_IOMUX_PAD_DEFINE (0x604, 0x234), // ESAI_TX_CLK
  IMX_PAD_GPIO_7 = IMX_IOMUX_PAD_DEFINE (0x608, 0x238), // ESAI_TX4_RX1
  IMX_PAD_GPIO_8 = IMX_IOMUX_PAD_DEFINE (0x60C, 0x23C), // ESAI_TX5_RX0
  IMX_PAD_GPIO_9 = IMX_IOMUX_PAD_DEFINE (0x610, 0x240), // ESAI_RX_FS
  IMX_PAD_SD2_CLK = IMX_IOMUX_PAD_DEFINE (0x6DC, 0x2F4), // SD2_CLK
  IMX_PAD_SD2_CMD = IMX_IOMUX_PAD_DEFINE (0x6E0, 0x2F8), // SD2_CMD
  IMX_PAD_SD2_DAT3 = IMX_IOMUX_PAD_DEFINE (0x6F0, 0x308), // SD2_DATA3
  IMX_PAD_SD2_DAT2 = IMX_IOMUX_PAD_DEFINE (0x6EC, 0x304), // SD2_DATA2
  IMX_PAD_SD2_DAT1 = IMX_IOMUX_PAD_DEFINE (0x6E8, 0x300), // SD2_DATA1
  IMX_PAD_SD2_DAT0 = IMX_IOMUX_PAD_DEFINE (0x6E4, 0x2FC), // SD2_DATA0
  IMX_PAD_SD1_DAT0 = IMX_IOMUX_PAD_DEFINE (0x6CC, 0x2E4), // SD1_DATA0
  IMX_PAD_SD1_DAT1 = IMX_IOMUX_PAD_DEFINE (0x6D0, 0x2E8), // SD1_DATA1
  IMX_PAD_SD1_CMD = IMX_IOMUX_PAD_DEFINE (0x6C8, 0x2E0), // SD1_CMD
  IMX_PAD_SD1_DAT2 = IMX_IOMUX_PAD_DEFINE (0x6D4, 0x2EC), // SD1_DATA2
  IMX_PAD_SD1_CLK = IMX_IOMUX_PAD_DEFINE (0x6C4, 0x2DC), // SD1_CLK
  IMX_PAD_SD1_DAT3 = IMX_IOMUX_PAD_DEFINE (0x6D8, 0x2F0), // SD1_DATA3
  IMX_PAD_ENET_MDIO = IMX_IOMUX_PAD_DEFINE (0x5BC, 0x1EC), // ENET_MDIO
  IMX_PAD_ENET_REF_CLK = IMX_IOMUX_PAD_DEFINE (0x5C0, 0x1F0), // ENET_TX_CLK
  IMX_PAD_ENET_RX_ER = IMX_IOMUX_PAD_DEFINE (0x5C4, 0x1F4), // USB_OTG_ID
  IMX_PAD_ENET_CRS_DV = IMX_IOMUX_PAD_DEFINE (0x5B4, 0x1E4), // ENET_RX_EN
  IMX_PAD_ENET_RXD1 = IMX_IOMUX_PAD_DEFINE (0x5CC, 0x1FC), // MLB_SIG
  IMX_PAD_ENET_RXD0 = IMX_IOMUX_PAD_DEFINE (0x5C8, 0x1F8), // ENET_RX_DATA0
  IMX_PAD_ENET_TX_EN = IMX_IOMUX_PAD_DEFINE (0x5D0, 0x200), // ENET_TX_EN
  IMX_PAD_ENET_TXD1 = IMX_IOMUX_PAD_DEFINE (0x5D8, 0x208), // MLB_CLK
  IMX_PAD_ENET_TXD0 = IMX_IOMUX_PAD_DEFINE (0x5D4, 0x204), // ENET_TX_DATA0
  IMX_PAD_ENET_MDC = IMX_IOMUX_PAD_DEFINE (0x5B8, 0x1E8), // MLB_DATA
  IMX_PAD_NANDF_D0 = IMX_IOMUX_PAD_DEFINE (0x66C, 0x284), // NAND_DATA00
  IMX_PAD_NANDF_D1 = IMX_IOMUX_PAD_DEFINE (0x670, 0x288), // NAND_DATA01
  IMX_PAD_NANDF_D2 = IMX_IOMUX_PAD_DEFINE (0x674, 0x28C), // NAND_DATA02
  IMX_PAD_NANDF_D3 = IMX_IOMUX_PAD_DEFINE (0x678, 0x290), // NAND_DATA03
  IMX_PAD_NANDF_D4 = IMX_IOMUX_PAD_DEFINE (0x67C, 0x294), // NAND_DATA04
  IMX_PAD_NANDF_D5 = IMX_IOMUX_PAD_DEFINE (0x680, 0x298), // NAND_DATA05
  IMX_PAD_NANDF_D6 = IMX_IOMUX_PAD_DEFINE (0x684, 0x29C), // NAND_DATA06
  IMX_PAD_NANDF_D7 = IMX_IOMUX_PAD_DEFINE (0x688, 0x2A0), // NAND_DATA07
  IMX_PAD_SD4_DAT0 = IMX_IOMUX_PAD_DEFINE (0x728, 0x340), // SD4_DATA0
  IMX_PAD_SD4_DAT1 = IMX_IOMUX_PAD_DEFINE (0x72C, 0x344), // SD4_DATA1
  IMX_PAD_SD4_DAT2 = IMX_IOMUX_PAD_DEFINE (0x730, 0x348), // SD4_DATA2
  IMX_PAD_SD4_DAT3 = IMX_IOMUX_PAD_DEFINE (0x734, 0x34C), // SD4_DATA3
  IMX_PAD_SD4_DAT4 = IMX_IOMUX_PAD_DEFINE (0x738, 0x350), // SD4_DATA4
  IMX_PAD_SD4_DAT5 = IMX_IOMUX_PAD_DEFINE (0x73C, 0x354), // SD4_DATA5
  IMX_PAD_SD4_DAT6 = IMX_IOMUX_PAD_DEFINE (0x740, 0x358), // SD4_DATA6
  IMX_PAD_SD4_DAT7 = IMX_IOMUX_PAD_DEFINE (0x744, 0x35C), // SD4_DATA7
  IMX_PAD_EIM_A22 = IMX_IOMUX_PAD_DEFINE (0x4F8, 0x128), // EIM_ADDR22
  IMX_PAD_EIM_A21 = IMX_IOMUX_PAD_DEFINE (0x4F4, 0x124), // EIM_ADDR21
  IMX_PAD_EIM_A20 = IMX_IOMUX_PAD_DEFINE (0x4F0, 0x120), // EIM_ADDR20
  IMX_PAD_EIM_A19 = IMX_IOMUX_PAD_DEFINE (0x4EC, 0x11C), // EIM_ADDR19
  IMX_PAD_EIM_A18 = IMX_IOMUX_PAD_DEFINE (0x4E8, 0x118), // EIM_ADDR18
  IMX_PAD_EIM_A17 = IMX_IOMUX_PAD_DEFINE (0x4E4, 0x114), // EIM_ADDR17
  IMX_PAD_EIM_A16 = IMX_IOMUX_PAD_DEFINE (0x4E0, 0x110), // EIM_ADDR16
  IMX_PAD_EIM_CS0 = IMX_IOMUX_PAD_DEFINE (0x50C, 0x13C), // EIM_CS0_B
  IMX_PAD_EIM_CS1 = IMX_IOMUX_PAD_DEFINE (0x510, 0x140), // EIM_CS1_B
  IMX_PAD_EIM_OE = IMX_IOMUX_PAD_DEFINE (0x5A8, 0x1D8), // EIM_OE_B
  IMX_PAD_EIM_RW = IMX_IOMUX_PAD_DEFINE (0x5AC, 0x1DC), // EIM_RW
  IMX_PAD_EIM_LBA = IMX_IOMUX_PAD_DEFINE (0x5A4, 0x1D4), // EIM_LBA_B
  IMX_PAD_EIM_EB0 = IMX_IOMUX_PAD_DEFINE (0x594, 0x1C4), // EIM_EB0_B
  IMX_PAD_EIM_EB1 = IMX_IOMUX_PAD_DEFINE (0x598, 0x1C8), // EIM_EB1_B
  IMX_PAD_EIM_EB2 = IMX_IOMUX_PAD_DEFINE (0x59C, 0x1CC), // EIM_EB2_B
  IMX_PAD_EIM_EB3 = IMX_IOMUX_PAD_DEFINE (0x5A0, 0x1D0), // EIM_EB3_B
  IMX_PAD_EIM_DA0 = IMX_IOMUX_PAD_DEFINE (0x554, 0x184), // EIM_AD00
  IMX_PAD_EIM_DA1 = IMX_IOMUX_PAD_DEFINE (0x558, 0x188), // EIM_AD01
  IMX_PAD_EIM_DA2 = IMX_IOMUX_PAD_DEFINE (0x574, 0x1A4), // EIM_AD02
  IMX_PAD_EIM_DA3 = IMX_IOMUX_PAD_DEFINE (0x578, 0x1A8), // EIM_AD03
  IMX_PAD_EIM_DA4 = IMX_IOMUX_PAD_DEFINE (0x57C, 0x1AC), // EIM_AD04
  IMX_PAD_EIM_DA5 = IMX_IOMUX_PAD_DEFINE (0x580, 0x1B0), // EIM_AD05
  IMX_PAD_EIM_DA6 = IMX_IOMUX_PAD_DEFINE (0x584, 0x1B4), // EIM_AD06
  IMX_PAD_EIM_DA7 = IMX_IOMUX_PAD_DEFINE (0x588, 0x1B8), // EIM_AD07
  IMX_PAD_EIM_DA8 = IMX_IOMUX_PAD_DEFINE (0x58C, 0x1BC), // EIM_AD08
  IMX_PAD_EIM_DA9 = IMX_IOMUX_PAD_DEFINE (0x590, 0x1C0), // EIM_AD09
  IMX_PAD_EIM_DA10 = IMX_IOMUX_PAD_DEFINE (0x55C, 0x18C), // EIM_AD10
  IMX_PAD_EIM_DA11 = IMX_IOMUX_PAD_DEFINE (0x560, 0x190), // EIM_AD11
  IMX_PAD_EIM_DA12 = IMX_IOMUX_PAD_DEFINE (0x564, 0x194), // EIM_AD12
  IMX_PAD_EIM_DA13 = IMX_IOMUX_PAD_DEFINE (0x568, 0x198), // EIM_AD13
  IMX_PAD_EIM_DA14 = IMX_IOMUX_PAD_DEFINE (0x56C, 0x19C), // EIM_AD14
  IMX_PAD_EIM_DA15 = IMX_IOMUX_PAD_DEFINE (0x570, 0x1A0), // EIM_AD15
  IMX_PAD_EIM_D16 = IMX_IOMUX_PAD_DEFINE (0x514, 0x144), // EIM_DATA16
  IMX_PAD_EIM_D17 = IMX_IOMUX_PAD_DEFINE (0x518, 0x148), // EIM_DATA17
  IMX_PAD_EIM_D18 = IMX_IOMUX_PAD_DEFINE (0x51C, 0x14C), // EIM_DATA18
  IMX_PAD_EIM_D19 = IMX_IOMUX_PAD_DEFINE (0x520, 0x150), // EIM_DATA19
  IMX_PAD_EIM_D20 = IMX_IOMUX_PAD_DEFINE (0x524, 0x154), // EIM_DATA20
  IMX_PAD_EIM_D21 = IMX_IOMUX_PAD_DEFINE (0x528, 0x158), // EIM_DATA21
  IMX_PAD_EIM_D22 = IMX_IOMUX_PAD_DEFINE (0x52C, 0x15C), // EIM_DATA22
  IMX_PAD_EIM_D23 = IMX_IOMUX_PAD_DEFINE (0x530, 0x160), // EIM_DATA23
  IMX_PAD_EIM_D24 = IMX_IOMUX_PAD_DEFINE (0x534, 0x164), // EIM_DATA24
  IMX_PAD_EIM_D25 = IMX_IOMUX_PAD_DEFINE (0x538, 0x168), // EIM_DATA25
  IMX_PAD_EIM_D26 = IMX_IOMUX_PAD_DEFINE (0x53C, 0x16C), // EIM_DATA26
  IMX_PAD_EIM_D27 = IMX_IOMUX_PAD_DEFINE (0x540, 0x170), // EIM_DATA27
  IMX_PAD_EIM_D28 = IMX_IOMUX_PAD_DEFINE (0x544, 0x174), // EIM_DATA28
  IMX_PAD_EIM_D29 = IMX_IOMUX_PAD_DEFINE (0x548, 0x178), // EIM_DATA29
  IMX_PAD_EIM_D30 = IMX_IOMUX_PAD_DEFINE (0x54C, 0x17C), // EIM_DATA30
  IMX_PAD_EIM_D31 = IMX_IOMUX_PAD_DEFINE (0x550, 0x180), // EIM_DATA31
  IMX_PAD_GPIO_19 = IMX_IOMUX_PAD_DEFINE (0x5F0, 0x220), // KEY_COL5
  IMX_PAD_KEY_COL0 = IMX_IOMUX_PAD_DEFINE (0x62C, 0x244), // ECSPI1_SCLK
  IMX_PAD_KEY_ROW0 = IMX_IOMUX_PAD_DEFINE (0x640, 0x258), // ECSPI1_MOSI
  IMX_PAD_KEY_COL1 = IMX_IOMUX_PAD_DEFINE (0x630, 0x248), // ECSPI1_MISO
  IMX_PAD_KEY_ROW1 = IMX_IOMUX_PAD_DEFINE (0x644, 0x25C), // ECSPI1_SS0
  IMX_PAD_KEY_COL2 = IMX_IOMUX_PAD_DEFINE (0x634, 0x24C), // ECSPI1_SS1
  IMX_PAD_KEY_ROW2 = IMX_IOMUX_PAD_DEFINE (0x648, 0x260), // ECSPI1_SS2
  IMX_PAD_KEY_COL3 = IMX_IOMUX_PAD_DEFINE (0x638, 0x250), // ECSPI1_SS3
  IMX_PAD_KEY_ROW3 = IMX_IOMUX_PAD_DEFINE (0x64C, 0x264), // ASRC_EXT_CLK
  IMX_PAD_KEY_COL4 = IMX_IOMUX_PAD_DEFINE (0x63C, 0x254), // FLEXCAN2_TX
  IMX_PAD_KEY_ROW4 = IMX_IOMUX_PAD_DEFINE (0x650, 0x268), // FLEXCAN2_RX
  IMX_PAD_DI0_DISP_CLK = IMX_IOMUX_PAD_DEFINE (0x3B0, 0x9C), // IPU1_DI0_DISP_CLK
  IMX_PAD_DI0_PIN15 = IMX_IOMUX_PAD_DEFINE (0x3B4, 0xA0), // IPU1_DI0_PIN15
  IMX_PAD_DI0_PIN2 = IMX_IOMUX_PAD_DEFINE (0x3B8, 0xA4), // IPU1_DI0_PIN02
  IMX_PAD_DI0_PIN3 = IMX_IOMUX_PAD_DEFINE (0x3BC, 0xA8), // IPU1_DI0_PIN03
  IMX_PAD_DI0_PIN4 = IMX_IOMUX_PAD_DEFINE (0x3C0, 0xAC), // IPU1_DI0_PIN04
  IMX_PAD_DISP0_DAT0 = IMX_IOMUX_PAD_DEFINE (0x3C4, 0xB0), // IPU1_DISP0_DATA00
  IMX_PAD_DISP0_DAT1 = IMX_IOMUX_PAD_DEFINE (0x3C8, 0xB4), // IPU1_DISP0_DATA01
  IMX_PAD_DISP0_DAT2 = IMX_IOMUX_PAD_DEFINE (0x3F4, 0xE0), // IPU1_DISP0_DATA02
  IMX_PAD_DISP0_DAT3 = IMX_IOMUX_PAD_DEFINE (0x408, 0xF4), // IPU1_DISP0_DATA03
  IMX_PAD_DISP0_DAT4 = IMX_IOMUX_PAD_DEFINE (0x40C, 0xF8), // IPU1_DISP0_DATA04
  IMX_PAD_DISP0_DAT5 = IMX_IOMUX_PAD_DEFINE (0x410, 0xFC), // IPU1_DISP0_DATA05
  IMX_PAD_DISP0_DAT6 = IMX_IOMUX_PAD_DEFINE (0x414, 0x100), // IPU1_DISP0_DATA06
  IMX_PAD_DISP0_DAT7 = IMX_IOMUX_PAD_DEFINE (0x418, 0x104), // IPU1_DISP0_DATA07
  IMX_PAD_DISP0_DAT8 = IMX_IOMUX_PAD_DEFINE (0x41C, 0x108), // IPU1_DISP0_DATA08
  IMX_PAD_DISP0_DAT9 = IMX_IOMUX_PAD_DEFINE (0x420, 0x10C), // IPU1_DISP0_DATA09
  IMX_PAD_DISP0_DAT10 = IMX_IOMUX_PAD_DEFINE (0x3CC, 0xB8), // IPU1_DISP0_DATA10
  IMX_PAD_EIM_WAIT = IMX_IOMUX_PAD_DEFINE (0x5B0, 0x1E0), // EIM_WAIT_B
  IMX_PAD_EIM_A25 = IMX_IOMUX_PAD_DEFINE (0x504, 0x134), // EIM_ADDR25
  IMX_PAD_EIM_A24 = IMX_IOMUX_PAD_DEFINE (0x500, 0x130), // EIM_ADDR24
  IMX_PAD_DISP0_DAT11 = IMX_IOMUX_PAD_DEFINE (0x3D0, 0xBC), // IPU1_DISP0_DATA11
  IMX_PAD_DISP0_DAT12 = IMX_IOMUX_PAD_DEFINE (0x3D4, 0xC0), // IPU1_DISP0_DATA12
  IMX_PAD_DISP0_DAT13 = IMX_IOMUX_PAD_DEFINE (0x3D8, 0xC4), // IPU1_DISP0_DATA13
  IMX_PAD_DISP0_DAT14 = IMX_IOMUX_PAD_DEFINE (0x3DC, 0xC8), // IPU1_DISP0_DATA14
  IMX_PAD_DISP0_DAT15 = IMX_IOMUX_PAD_DEFINE (0x3E0, 0xCC), // IPU1_DISP0_DATA15
  IMX_PAD_DISP0_DAT16 = IMX_IOMUX_PAD_DEFINE (0x3E4, 0xD0), // IPU1_DISP0_DATA16
  IMX_PAD_DISP0_DAT17 = IMX_IOMUX_PAD_DEFINE (0x3E8, 0xD4), // IPU1_DISP0_DATA17
  IMX_PAD_DISP0_DAT18 = IMX_IOMUX_PAD_DEFINE (0x3EC, 0xD8), // IPU1_DISP0_DATA18
  IMX_PAD_DISP0_DAT19 = IMX_IOMUX_PAD_DEFINE (0x3F0, 0xDC), // IPU1_DISP0_DATA19
  IMX_PAD_DISP0_DAT20 = IMX_IOMUX_PAD_DEFINE (0x3F8, 0xE4), // IPU1_DISP0_DATA20
  IMX_PAD_DISP0_DAT21 = IMX_IOMUX_PAD_DEFINE (0x3FC, 0xE8), // IPU1_DISP0_DATA21
  IMX_PAD_DISP0_DAT22 = IMX_IOMUX_PAD_DEFINE (0x400, 0xEC), // IPU1_DISP0_DATA22
  IMX_PAD_DISP0_DAT23 = IMX_IOMUX_PAD_DEFINE (0x404, 0xF0), // IPU1_DISP0_DATA23
  IMX_PAD_CSI0_PIXCLK = IMX_IOMUX_PAD_DEFINE (0x3A8, 0x94), // IPU1_CSI0_PIXCLK
  IMX_PAD_CSI0_MCLK = IMX_IOMUX_PAD_DEFINE (0x3A4, 0x90), // IPU1_CSI0_HSYNC
  IMX_PAD_CSI0_DATA_EN = IMX_IOMUX_PAD_DEFINE (0x3A0, 0x8C), // IPU1_CSI0_DATA_EN
  IMX_PAD_CSI0_VSYNC = IMX_IOMUX_PAD_DEFINE (0x3AC, 0x98), // IPU1_CSI0_VSYNC
  IMX_PAD_CSI0_DAT4 = IMX_IOMUX_PAD_DEFINE (0x388, 0x74), // IPU1_CSI0_DATA04
  IMX_PAD_CSI0_DAT5 = IMX_IOMUX_PAD_DEFINE (0x38C, 0x78), // IPU1_CSI0_DATA05
  IMX_PAD_CSI0_DAT6 = IMX_IOMUX_PAD_DEFINE (0x390, 0x7C), // IPU1_CSI0_DATA06
  IMX_PAD_CSI0_DAT7 = IMX_IOMUX_PAD_DEFINE (0x394, 0x80), // IPU1_CSI0_DATA07
  IMX_PAD_CSI0_DAT8 = IMX_IOMUX_PAD_DEFINE (0x398, 0x84), // IPU1_CSI0_DATA08
  IMX_PAD_CSI0_DAT9 = IMX_IOMUX_PAD_DEFINE (0x39C, 0x88), // IPU1_CSI0_DATA09
  IMX_PAD_CSI0_DAT10 = IMX_IOMUX_PAD_DEFINE (0x360, 0x4C), // IPU1_CSI0_DATA10
  IMX_PAD_CSI0_DAT11 = IMX_IOMUX_PAD_DEFINE (0x364, 0x50), // IPU1_CSI0_DATA11
  IMX_PAD_CSI0_DAT12 = IMX_IOMUX_PAD_DEFINE (0x368, 0x54), // IPU1_CSI0_DATA12
  IMX_PAD_CSI0_DAT13 = IMX_IOMUX_PAD_DEFINE (0x36C, 0x58), // IPU1_CSI0_DATA13
  IMX_PAD_CSI0_DAT14 = IMX_IOMUX_PAD_DEFINE (0x370, 0x5C), // IPU1_CSI0_DATA14
  IMX_PAD_CSI0_DAT15 = IMX_IOMUX_PAD_DEFINE (0x374, 0x60), // IPU1_CSI0_DATA15
  IMX_PAD_CSI0_DAT16 = IMX_IOMUX_PAD_DEFINE (0x378, 0x64), // IPU1_CSI0_DATA16
  IMX_PAD_CSI0_DAT17 = IMX_IOMUX_PAD_DEFINE (0x37C, 0x68), // IPU1_CSI0_DATA17
  IMX_PAD_CSI0_DAT18 = IMX_IOMUX_PAD_DEFINE (0x380, 0x6C), // IPU1_CSI0_DATA18
  IMX_PAD_CSI0_DAT19 = IMX_IOMUX_PAD_DEFINE (0x384, 0x70), // IPU1_CSI0_DATA19
  IMX_PAD_EIM_A23 = IMX_IOMUX_PAD_DEFINE (0x4FC, 0x12C), // EIM_ADDR23
  IMX_PAD_NANDF_CLE = IMX_IOMUX_PAD_DEFINE (0x658, 0x270), // NAND_CLE
  IMX_PAD_NANDF_ALE = IMX_IOMUX_PAD_DEFINE (0x654, 0x26C), // NAND_ALE
  IMX_PAD_NANDF_WP_B = IMX_IOMUX_PAD_DEFINE (0x690, 0x2A8), // NAND_WP_B
  IMX_PAD_NANDF_RB0 = IMX_IOMUX_PAD_DEFINE (0x68C, 0x2A4), // NAND_READY_B
  IMX_PAD_NANDF_CS0 = IMX_IOMUX_PAD_DEFINE (0x65C, 0x274), // NAND_CE0_B
  IMX_PAD_NANDF_CS1 = IMX_IOMUX_PAD_DEFINE (0x660, 0x278), // NAND_CE1_B
  IMX_PAD_NANDF_CS2 = IMX_IOMUX_PAD_DEFINE (0x664, 0x27C), // NAND_CE2_B
  IMX_PAD_NANDF_CS3 = IMX_IOMUX_PAD_DEFINE (0x668, 0x280), // NAND_CE3_B
  IMX_PAD_SD3_DAT7 = IMX_IOMUX_PAD_DEFINE (0x718, 0x330), // SD3_DATA7
  IMX_PAD_SD3_DAT6 = IMX_IOMUX_PAD_DEFINE (0x714, 0x32C), // SD3_DATA6
  IMX_PAD_RGMII_TXC = IMX_IOMUX_PAD_DEFINE (0x6C0, 0x2D8), // USB_H2_DATA
  IMX_PAD_RGMII_TD0 = IMX_IOMUX_PAD_DEFINE (0x6AC, 0x2C4), // HSI_TX_READY
  IMX_PAD_RGMII_TD1 = IMX_IOMUX_PAD_DEFINE (0x6B0, 0x2C8), // HSI_RX_FLAG
  IMX_PAD_RGMII_TD2 = IMX_IOMUX_PAD_DEFINE (0x6B4, 0x2CC), // HSI_RX_DATA
  IMX_PAD_RGMII_TD3 = IMX_IOMUX_PAD_DEFINE (0x6B8, 0x2D0), // HSI_RX_WAKE
  IMX_PAD_RGMII_RX_CTL = IMX_IOMUX_PAD_DEFINE (0x6A4, 0x2BC), // USB_H3_DATA
  IMX_PAD_RGMII_RD0 = IMX_IOMUX_PAD_DEFINE (0x694, 0x2AC), // HSI_RX_READY
  IMX_PAD_RGMII_TX_CTL = IMX_IOMUX_PAD_DEFINE (0x6BC, 0x2D4), // USB_H2_STROBE
  IMX_PAD_RGMII_RD1 = IMX_IOMUX_PAD_DEFINE (0x698, 0x2B0), // HSI_TX_FLAG
  IMX_PAD_RGMII_RD2 = IMX_IOMUX_PAD_DEFINE (0x69C, 0x2B4), // HSI_TX_DATA
  IMX_PAD_RGMII_RD3 = IMX_IOMUX_PAD_DEFINE (0x6A0, 0x2B8), // HSI_TX_WAKE
  IMX_PAD_RGMII_RXC = IMX_IOMUX_PAD_DEFINE (0x6A8, 0x2C0), // USB_H3_STROBE
  IMX_PAD_EIM_BCLK = IMX_IOMUX_PAD_DEFINE (0x508, 0x138), // EIM_BCLK
  IMX_PAD_SD3_DAT5 = IMX_IOMUX_PAD_DEFINE (0x710, 0x328), // SD3_DATA5
  IMX_PAD_SD3_DAT4 = IMX_IOMUX_PAD_DEFINE (0x70C, 0x324), // SD3_DATA4
  IMX_PAD_SD3_CMD = IMX_IOMUX_PAD_DEFINE (0x6F8, 0x310), // SD3_CMD
  IMX_PAD_SD3_CLK = IMX_IOMUX_PAD_DEFINE (0x6F4, 0x30C), // SD3_CLK
  IMX_PAD_SD3_DAT0 = IMX_IOMUX_PAD_DEFINE (0x6FC, 0x314), // SD3_DATA0
  IMX_PAD_SD3_DAT1 = IMX_IOMUX_PAD_DEFINE (0x700, 0x318), // SD3_DATA1
  IMX_PAD_SD3_DAT2 = IMX_IOMUX_PAD_DEFINE (0x704, 0x31C), // SD3_DATA2
  IMX_PAD_SD3_DAT3 = IMX_IOMUX_PAD_DEFINE (0x708, 0x320), // SD3_DATA3
  IMX_PAD_SD3_RST = IMX_IOMUX_PAD_DEFINE (0x71C, 0x334), // SD3_RESET
  IMX_PAD_SD4_CMD = IMX_IOMUX_PAD_DEFINE (0x724, 0x33C), // SD4_CMD
  IMX_PAD_SD4_CLK = IMX_IOMUX_PAD_DEFINE (0x720, 0x338), // SD4_CLK
  IMX_PAD_GPIO_16 = IMX_IOMUX_PAD_DEFINE (0x5E4, 0x214), // ESAI_TX3_RX2
  IMX_PAD_GPIO_17 = IMX_IOMUX_PAD_DEFINE (0x5E8, 0x218), // ESAI_TX0
  IMX_PAD_GPIO_18 = IMX_IOMUX_PAD_DEFINE (0x5EC, 0x21C), // ESAI_TX1
} IMX_PAD;
