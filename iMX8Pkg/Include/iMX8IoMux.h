...
typedef enum {
    IMX_VSEL_0_AUTO,	// Auto detect 3.3/2.5/1.2/1.8 V mode
    IMX_VSEL_1_AUTO,	// Auto detect 3.3/2.5/1.2/1.8 V mode
    IMX_VSEL_2_AUTO,	// Auto detect 3.3/2.5/1.2/1.8 V mode
    IMX_VSEL_3_AUTO,	// Auto detect 3.3/2.5/1.2/1.8 V mode
    IMX_VSEL_4_MANUAL_3P3V,	// Manual 3.3V mode
    IMX_VSEL_5_MANUAL_2P5V,	// Manual 2.5V mode
    IMX_VSEL_6_MANUAL_2P5V,	// Manual 2.5V mode
    IMX_VSEL_7_MANUAL_1P2_1P8V,	// Manual 1.2V/1.8V mode
} IMX_VSEL;

typedef enum {
    IMX_LVTTL_0_LVTTL_Disabled,
    IMX_LVTTL_1_LVTTL_Enabled,
} IMX_LVTTL;
...
typedef enum {
    IMX_SRE_0_SLOW, 	// 50 MHz
    IMX_SRE_1_MEDIUM, 	// 100 MHz
    IMX_SRE_2_FAST,	// 150 MHz
    IMX_SRE_3_MAX,	// 200 MHz
} IMX_SRE;
...
// 9 bits - not including VSEL yet.
#define _IMX_MAKE_PAD_CTL(Dse, Sre, Ode, Pue, Hys, Lvttl) \
          (((Dse) & 0x7) | \
          (((Sre) & 0x3) << 3) | \
          (((Ode) & 0x1) << 5) | \
          (((Pue) & 0x1) << 6) | \
...
/**
  ...
  Sre - IMX_SRE - Slew Rate setting (Bit 3,4)
  Ode - IMX_ODE - Open Drain Enable (bit 5)
  Pue - IMX_PUE - Pull Up Enable (bit 6)
  Hys - IMX_HYS - Hysteresis enable (Bit 7)
  Lvttl - IMX_LVTTL - Low Voltage TTL enable (Bit 8)
...
**/
   ...
   I2C4_SDA_ALT2 = 0x0 // Selecting ALT2 of pad I2C4_SDA for PCIE2_CLKREQ_B
   ...
   UART4_TXD_ALT2 = 0x1 // Selecting ALT2 of pad UART4_TXD for PCIE2_CLKREQ_B
#endif
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO00_ALT1_CCM_ENET_PHY_REF_CLK_ROOT = 1,
   IMX_IOMUXC_GPIO1_IO00_ALT5_ANAMIX_REF_CLK_32K = 5,
   IMX_IOMUXC_GPIO1_IO00_ALT6_CCM_EXT_CLK1 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO01_ALT6_CCM_EXT_CLK2 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO06_ALT6_CCM_EXT_CLK3 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO07_ALT6_CCM_EXT_CLK4 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO14_ALT6_CCM_CLKO1 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_GPIO1_IO15_ALT6_CCM_CLKO2 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI5_MCLK_ALT2_SAI4_MCLK = 2,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD0_ALT6_SRC_BOOT_CFG0 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD1_ALT6_SRC_BOOT_CFG1 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD2_ALT6_SRC_BOOT_CFG2 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD3_ALT6_SRC_BOOT_CFG3 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD4_ALT6_SRC_BOOT_CFG4 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD5_ALT6_SRC_BOOT_CFG5 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD6_ALT6_SRC_BOOT_CFG6 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_RXD7_ALT6_SRC_BOOT_CFG7 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD0_ALT6_SRC_BOOT_CFG8 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD1_ALT6_SRC_BOOT_CFG9 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD2_ALT6_SRC_BOOT_CFG10 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD3_ALT6_SRC_BOOT_CFG11 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD4_ALT6_SRC_BOOT_CFG12 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD5_ALT6_SRC_BOOT_CFG13 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD6_ALT6_SRC_BOOT_CFG14 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI1_TXD7_ALT6_SRC_BOOT_CFG15 = 6,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI3_RXC_ALT1_GPT1_CAPTURE2 = 1,
...
typedef enum {
   ...
   IMX_IOMUXC_SAI3_TXFS_ALT1_GPT1_CLK = 1,
...
typedef enum {
   ...
   IMX_IOMUXC_I2C4_SDA_ALT2_PCIE2_CLKREQ_B = 2,
...
typedef enum {
   ...
   IMX_IOMUXC_UART4_TXD_ALT2_PCIE2_CLKREQ_B = 2,
